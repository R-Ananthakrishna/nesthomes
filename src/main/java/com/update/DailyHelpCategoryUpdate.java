...
public class DailyHelpCategoryUpdate extends HttpServlet{
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		out.print("<!DOCTYPE html>"
				...
				+ "    <title>Daily Help Category Update</title>"
				...
				+ "        <form id='category' name='category' method='post' action='DailyHelpCategoryUpdateAction'>");
		...
		for(DailyHelpCategoryBean dhc:dailyHelpCategoryFetch){
			out.print("         <input type='hidden' id='dhcId' name='dhcId' value='"+dhc.getDhcId()+"'><br>"
					...
					+ "         <input type='text' id='categoryName' name='categoryName' value='"+dhc.getDhcCategory()+"'>"
					+ "         <br><br><br><br>"
