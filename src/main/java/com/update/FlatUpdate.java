...
public class FlatUpdate extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException{
		...
		out.print("<!DOCTYPE html>"
				...
				+ "    <title>Flat Details Update</title>"
				...
				+ "        <form id='flat' name='flat' method='post' action='FlatUpdateAction'>");
		
		for(FlatBean f : flatFetch) {
			
			out.print("            <input type='hidden' id='flId' name='flId' value='"+f.getFlId()+"'><br>"
					+ "			   <label>Flat No.</label>"
					+ "            <input type='text' id='flatNo' name='flatNo' value='"+f.getFlNo()+"'>"
					+ "            <br><br><br>"
					+ "            <label>Flat Type</label>"
					+ "            <input type='text' id='flatType' name='flatType' value='"+f.getFlType()+"'>"
					+ "            <br><br><br>"
					+ "            <label>Flat Tower</label>"
					+ "            <input type='text' id='flatTower' name='flatTower' value='"+f.getFlTower()+"'>"
					+ "            <br><br><br><br>"
