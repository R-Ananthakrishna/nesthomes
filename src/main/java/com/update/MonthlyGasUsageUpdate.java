...
public class MonthlyGasUsageUpdate extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException{
		...
		out.print("<!DOCTYPE html>"
				...
				+ "    <title>Monthly Gas Usage Update</title>"
				...
				+ "        <form id='gasUsage' name='gasUsage' method='post' action='MonthlyGasUsageUpdateAction'>");
		...
		for(MonthlyGasUsageBean mgc: monthlyGasUsageFetch) {
			...
			out.print("            </select>"
					+ "            <br><br><br>"
					+ "            <label>Unit</label>"
					+ "            <input type='number' id='unit' name='unit' value='"+mgc.getGasUnit()+"' min='0' step='0.01'>"
					+ "            <br><br><br><br>"
