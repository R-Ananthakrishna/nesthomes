...
public class UserDetailsDelete extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException{
		...
		out.print("<!DOCTYPE html>"
				...
				+ "        <form id='user' name='user' method='post' action='UserDetailsDeleteAction'>");
		
		for(UserDetailsBean user: userDetailsFetch) {
			
			out.print("            <input type='hidden' id='uId' name='uId' value='"+user.getuId()+"'><br>"
					+ "			   <label>User Name</label>"
					+ "            <input type='text' id='uName' name='uName' readonly='true' value='"+user.getuName()+"'>"
					+ "            <br><br><br>"
					+ "            <label>Password</label>"
					+ "            <input type='text' id='pass' name='pass' readonly='true' value='"+user.getPass()+"'>"
					+ "            <br><br><br>"
					+ "            <label>User Type</label>"
					+ "            <select id='uType' name='uType' readonly='true'>"
