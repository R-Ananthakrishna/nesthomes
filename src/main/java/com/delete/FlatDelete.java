...
public class FlatDelete extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException{
		...
		ArrayList<FlatBean> flatFetch=null;
		
		try {
			
			flatFetch = FlatDAO.fetchFlatById(flId);
		...
		out.print("<!DOCTYPE html>"
				...
				+ "    <title>Flat Details Delete</title>"
				...
				+ "        <form id='flat' name='flat' method='post' action='FlatDeleteAction'>");
		
		for(FlatBean f : flatFetch) {
			
			out.print("            <input type='hidden' id='flId' name='flId' value='"+f.getFlId()+"'><br>"
					+ "			   <label>Flat No.</label>"
					+ "            <input type='text' id='flatNo' name='flatNo' readonly='true' value='"+f.getFlNo()+"'>"
					+ "            <br><br><br>"
					+ "            <label>Flat Type</label>"
					+ "            <input type='text' id='flatType' name='flatType' readonly='true' value='"+f.getFlType()+"'>"
					+ "            <br><br><br>"
					+ "            <label>Flat Tower</label>"
					+ "            <input type='text' id='flatTower' name='flatTower' readonly='true' value='"+f.getFlTower()+"'>"
					+ "            <br><br><br><br>"
