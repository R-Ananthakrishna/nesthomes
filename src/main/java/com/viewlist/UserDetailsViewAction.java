...
public class UserDetailsViewAction extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		out.print("<!DOCTYPE html>"
				...
				+ "    <script src='./js/user-detail.js' type='text/javascript'></script>"
				+ "</head>"
				+ "<body>"
				+ "    <nav class='navbar'>"
				...
				+ "            <input type='text' placeholder='Enter the user name' id='uName' name='uName'>"
				+ "            <br><br><br>"
				+ "            <label>Password</label>"
				+ "            <input type='text' placeholder='Enter the password' id='pass' name='pass'>"
				+ "            <br><br><br>"
