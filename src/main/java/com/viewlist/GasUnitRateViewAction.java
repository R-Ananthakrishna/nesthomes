...
public class GasUnitRateViewAction extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		out.print("<!DOCTYPE html>"
				...
				+ "        <form id='rate' name='rate' method='post' action='GasUnitRate'>"
				+ "            <label>Rate</label>"
				+ "            <input type='number' placeholder='Enter Gas Unit Rate' id='gasRate' name='gasRate' min='0' step='0.01'>&nbsp;<small style='font-size: 19px;'>per unit</small>"
				+ "            <br><br><br><br>"
