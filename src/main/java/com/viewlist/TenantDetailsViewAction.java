...
public class TenantDetailsViewAction extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		out.print("<!DOCTYPE html>"
				...
				+ "        <form id='tenant' name='tenant' method='post' action='TenantDetails'>"
				+ "            <label>Tenant Name</label>"
				+ "            <input type='text' placeholder='Enter the name' id='tName' name='tName'>"
				+ "            <br><br><br>"
				+ "            <div class='textarea'>"
				+ "              <label>Address</label>"
